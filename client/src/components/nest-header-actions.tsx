                            ...
                            <Tooltip>
                                <TooltipTrigger asChild>
                                    <Button 
                                        ...
                                        className="size-4" 
                                        onClick={() => {
                                            window.open(`https://arbiscan.io/address/${safeDetails.address}`, '_blank');
                                        }}
                                    >
                                ...
                                <TooltipContent>See in explorer</TooltipContent>
                            </Tooltip>  
                        </div>
                        <div 
                            className="flex items-center gap-2 px-3 py-2 rounded-[8px] bg-nest-page border border-nest-super-light text-white"
                        >
                            <span className="text-sm text-nowrap font-medium">{formatUnits(safeBalanceData?.value || 0n, safeBalanceData?.decimals || 18)}</span>
