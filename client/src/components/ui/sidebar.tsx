        ...
        return (
            ...
            >
                ...
                >
                    <div
                        data-sidebar="sidebar"
                        className="flex rounded-md w-full flex-col group-data-[variant=floating]:border group-data-[variant=floating]:border-sidebar-border group-data-[variant=floating]:shadow"
                    >
                        {children}
                    </div>
                </div>
