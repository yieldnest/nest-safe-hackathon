...
BEGIN
    ...
    -- Then check for Heurist
    ELSIF current_setting('app.use_heurist_embedding', TRUE) = 'true' THEN
...
CREATE INDEX IF NOT EXISTS idx_knowledge_metadata ON knowledge("agentId", "isShared");
