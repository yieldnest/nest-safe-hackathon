...
elizaLogger.info("Loading embedding settings:", {
    ...
    USE_HEURIST_EMBEDDING: process.env.USE_HEURIST_EMBEDDING,
    USE_GAIANET_EMBEDDING: process.env.USE_GAIANET_EMBEDDING,
    OLLAMA_EMBEDDING_MODEL:
        process.env.OLLAMA_EMBEDDING_MODEL || "mxbai-embed-large",
    HEURIST_EMBEDDING_MODEL:
        process.env.HEURIST_EMBEDDING_MODEL || "bge-large-en-v1.5",
    GAIANET_EMBEDDING_MODEL:
        process.env.GAIANET_EMBEDDING_MODEL || "nomic-embed",
});
...
elizaLogger.info("Parsed settings:", {
    ...
    USE_HEURIST_EMBEDDING_TYPE: typeof settings.USE_HEURIST_EMBEDDING,
    USE_GAIANET_EMBEDDING: settings.USE_GAIANET_EMBEDDING,
    USE_GAIANET_EMBEDDING_TYPE: typeof settings.USE_GAIANET_EMBEDDING,
    OLLAMA_EMBEDDING_MODEL:
        settings.OLLAMA_EMBEDDING_MODEL || "mxbai-embed-large",
    HEURIST_EMBEDDING_MODEL:
        settings.HEURIST_EMBEDDING_MODEL || "bge-large-en-v1.5",
    GAIANET_EMBEDDING_MODEL:
